...
class ClientExecutionThread extends Thread {
	...
	public ClientExecutionThread(SortedMap<Double, MazePacket> localQueue, Integer numRemotes, Mazewar mazewar, Maze maze, String hostname, Integer port) {
	...
	public void run() {
			...
			if (move != null) {
				try {
					...
					if (move.getmsgType() == MazePacket.MAZE_REQUEST) {
						if (local) {
